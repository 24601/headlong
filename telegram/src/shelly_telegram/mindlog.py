...
Copied from shelly_slack.mindlog (the bridges are independent uv
...
def find_trajectory(identity_dir: Path) -> Path:
    """Locate the mind log, mirroring shelly_web.discovery.find_root_traj_dir."""
    info = {}
    ...
    raise SystemExit(f"shelly-telegram-bridge: no trajectory.jsonl under {traj_root}")
