...
Usage: shelly-telegram-bridge [ROOT]
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="shelly-telegram-bridge", description=__doc__)
    ...
    me = bot.get_me()
    print(
        f"shelly-telegram-bridge: identity={cfg.identity} bot=@{me.get('username')} "
