...
Usage: shellm-telegram-bridge [ROOT]
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="shellm-telegram-bridge", description=__doc__)
    ...
    me = bot.get_me()
    print(
        f"shellm-telegram-bridge: identity={cfg.identity} bot=@{me.get('username')} "
