...
Usage: shellm-slack-bridge [ROOT]
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="shellm-slack-bridge", description=__doc__)
    ...
    print(
        f"shellm-slack-bridge: identity={cfg.identity} bot={auth['user']} "
