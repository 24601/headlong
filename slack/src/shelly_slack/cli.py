...
Usage: shelly-slack-bridge [ROOT]
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="shelly-slack-bridge", description=__doc__)
    ...
    print(
        f"shelly-slack-bridge: identity={cfg.identity} bot={auth['user']} "
